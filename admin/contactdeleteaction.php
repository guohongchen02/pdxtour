...
if(!isset($_POST["confirm_delete"])) {  // Run only if coming from the current page
    ...
    if($missing_count > 0) {
         echo "<br />Please <a href='contactdelete.php'>Go Back</a> and fill in the missing data.<br /><br /></body></html>";
         exit;
    }
    ...
    while($rows = $result->fetch(PDO::FETCH_ASSOC)) {
     ...
     echo "<form method='post' action='contactdeleteaction.php'>"; // Submitting to this same page again
     ...
     echo "<a href='contactdelete.php'>Return to Delete Form</a>";
...
if ($_POST["confirm_delete"] == "Y") {
 ...
 try {
     ...
     // link to view page
     echo "<p><a href='contact.php'>View Contact message</a></p>";
	...
	echo "<p><a href='contactdelete.php'>Return to Delete Form</a></p>";
